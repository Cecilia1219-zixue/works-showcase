...
const API_URL = `https://${ENV_ID}.api.tcloudbasegateway.com/v1/envs/${ENV_ID}/functions/login`;
...
(async () => {
  const res = await fetch(API_URL, {
    ...
    headers: {
      ...
      'X-Faas-Authorization': PUB_KEY
    },
    body: JSON.stringify({ code: 'test_123' })
  });
